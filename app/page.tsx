...
export default async function LandingPage() {
  ...
  return (
    <main className='relative flex flex-col items-center justify-evenly min-h-screen p-8 text-center bg-gradient-to-b from-white to-gray-50 overflow-hidden'>
      <div className='max-w-3xl mx-auto px-4 sm:px-0 z-10'>
        <h1 className='text-4xl sm:text-5xl md:text-7xl font-bold bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent pb-4'>
